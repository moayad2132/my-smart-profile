...
I've added responsive Bootstrap carousel with three icons and quotes. 



2. About Me Page (about.html) 
This is the about me page.
this page conten a three section, my biography, hobbies, and personal goals.
and I added my Own style with an external CSS file (style.css) and Bootstrap to keep things clean and responsive.
...
in this page you can contact me if you have any qustions or advice.
I included a complete HTML form.
With fields sush as, your Name (text), Email, Age (number), Gender (radio buttons),
...
in This page I show some of my projects 
I Created a three of my personal projects using Bootstrap cards.
To make it more dynamic, 
I added some JavaScript so you can update one of the cards dynamically whene click in on the Card container or image will load
